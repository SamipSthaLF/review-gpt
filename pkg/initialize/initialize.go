...
func getFlags() {
	...
	setFlag(globals.UserStoryFlag.Names, &userStory, "", globals.UserStoryFlag.Help)
...
func Init() {
	...
	// request the api
	request.RequestApi(input,userStory, model, maxtokens, temperature, top_p, frequence, presence, bestof)
}
